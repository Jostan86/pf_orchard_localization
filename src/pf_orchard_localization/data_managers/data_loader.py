...
class Base(ABC):
    ...
    def num_messages(self, message_type: data_msgs.MsgType) -> int:
        """Returns the number of messages of a specific message type in the data

        Args:
            message_type: The message type to count

        Returns:
            int: The number of messages of the specified message type
        """
        return np.sum(self.msg_order == message_type.value)
    
    @property
    def num_wheel_odom_msgs(self) -> int:
        """Returns the number of wheel odometry messages in the data"""
        return self.num_messages(data_msgs.MsgType.WHEEL_ODOM)

    @property
    def num_visual_odom_msgs(self) -> int:
        """Returns the number of visual odometry messages in the data"""
    ...
    def num_imu_msgs(self) -> int:
        """Returns the number of IMU messages in the data"""
        return self.num_messages(data_msgs.MsgType.IMU)
    
    @property
    def num_gnss_uncorrected_msgs(self) -> int:
        """Returns the number of GNSS messages in the data"""
    ...
    def get_time_relative_to_start(self) -> float:
        """Returns the time relative to the start of the data"""
    ...
    def at_message_type(self, message_type: data_msgs.MsgType) -> bool:
        """Returns True if the current message is of the specified message type

        Args:
            message_type: The message type to check

        Returns:
            bool: True if the current message is of the specified message type
        """
    ...
    def get_next_img_msg(self) -> Union[data_msgs.Image, None]:
        """Get the next image message in the data, skipping any other messages
    ...
    def get_prev_img_msg(self):
        """Get the previous image message in the data, skipping any other messages
    ...
    def set_file_time_relative_to_start(self, timestamp: float):
        """Adjust the time relative to the start of the data

        Args:
            time: The time to adjust the current time to

        Returns:
            bool: True if the time stamp was set successfully
        """
    ...
    def set_file_time(self, timestamp: float) -> bool:
        ...
        Args:
            timestamp (float): The time stamp to set the current position to
...
class Ros2Bag(Ros1Bag):
    ...
    def __init__(self, file_path, data_parameters: ParametersBagData):
        """
        Extend the constructor of the BagDataLoader class to handle ros2 bag files
